            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    @elseif (auth()->guard('estudiante')->check())
                        <li><a class="dropdown-item" href="{{ route('estudiantes.logout') }}">Cerrar Sesión</a></li>
                    @else
                        <li><a class="dropdown-item" href="{{ route('docentes.showLoginForm') }}">Iniciar sesión como
                                Docente</a></li>
                        <li><a class="dropdown-item" href="{{ route('estudiantes.showLoginForm') }}">Iniciar sesión como
                                Estudiante</a></li>
                    @endif
